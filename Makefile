...
CC = gcc
SRC=floatimage.c floatimage_io.c filter.c error.c main.c parser.c
OBJ=floatimage.o floatimage_io.o filter.o main.o error.o parser.o
HDR=floatimage.h floatimage_io.h filter.h error.h parser.h
TARGET=FilterImage
...
parser.o: parsedefs.h floatimage_io.h floatimage.h filter.h error.h
errorflags.h errormessages.h: gen_errorflags.sh filter.c floatimage.c floatimage_io.c error.c parser.c
	${SHELL} gen_errorflags.sh filter.c floatimage.c floatimage_io.c error.c parser.c
